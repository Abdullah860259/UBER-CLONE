...
const RidesDescription = ({ setShowRidesDescription, showRidesDescription }) => {
    useEffect(() => {
    ...
    return (
        <div className={`absolute ${showRidesDescription ? '' : 'translate-y-full'} rides-container transition-transform duration-500 ease-in-out bottom-0 w-full max-h-[65vh] bg-white flex flex-col gap-3 pt-3 p-3 rounded-t-lg `} >
