  ...
  return (
    <div className="w-screen h-screen relative flex flex-col overflow-hidden items-center justify-center border border-black">
      ...
      <Rides
        showRides={showRides}
        setShowRides={setShowRides}
        setShowRidesDescription={setShowRidesDescription}
      />
      <RidesDescription
        setShowRidesDescription={setShowRidesDescription}
        showRidesDescription={showRidesDescription}
        setShowConfirmRide={setShowConfirmRide}
      />
      <ConfirmRide
        showConfirmRide={showConfirmRide}
        setShowConfirmRide={setShowConfirmRide}
      />
    </div>
  );
